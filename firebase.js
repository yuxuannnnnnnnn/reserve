...
const productionConfig = {
  ...
  storageBucket: "reserve-a3e41.appspot.com",
...
const developmentConfig = {
  ...
  authDomain: "reserve-demo-ae1eb.firebaseapp.com",
  databaseURL: "https://reserve-demo-ae1eb-default-rtdb.firebaseio.com",
  projectId: "reserve-demo-ae1eb",
  storageBucket: "reserve-demo-ae1eb.appspot.com",
  messagingSenderId: "3910946722",
  appId: "1:3910946722:web:80a1bd5021434512ca6cfb",
  measurementId: "G-PC427R3YWP"
};
...
// 初始化 Firebase
const app = initializeApp(firebaseConfig); // 這裡修正了變數名稱 firebaseConfi → firebaseConfig
